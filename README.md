...
- Analyze web traffic between browser and server  
- Modify requests for testing purposes  
- Understand web application behavior and vulnerabilities  

## Features Used
- Proxy (HTTP request interception)  
- Repeater (request modification and replay)  
...
- This project is for educational and ethical cybersecurity practice only  
